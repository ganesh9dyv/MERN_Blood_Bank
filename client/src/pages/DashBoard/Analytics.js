...
const Analytics = () => {
  ...
  const colors = [
    "#884A40","#C38155","#FFC26F","#4F779C","#4946E4",
    "#007AFF","#FF0160","#22A499",];
      ...
      <div className="d-flex flex-row flex-wrap">
        {data?.map((record,i)=>(
          <div className="card m-2 p-1" key={i} style={{ width: "18rem", backgroundColor: `${colors[i]}` }}>
            ...
            <div className="card-footer text-light bg-dark text-center"> Total Available : <b>{record.availabeBlood}</b> (ML) </div>
          </div>
        ))}
      </div>
      <div className="container my-3">
        <h1 className="my-3">5 Recent Blood Transactions</h1>
