    ...
    <div>
      <form onSubmit={(e)=>{
        ...
        <div className='form-check ms-2'>
            <input type='radio' className='form-check-input' name='role' id='donarRadio' value='donar' onChange={(e)=>setRole(e.target.value)}/>
        ...
        <div className="d-flex flex-row justify-content-between">
          {formType==='login' ? (
            <p>
              Not registered yet got to Register
              <Link to='/register'>  Here !</Link>
            </p>
          ):(<p>
            Already a User Pleaase Login
